...
// Call the function with required information and two other name-value pairs, such as a color or an optional feature.
...
;
var response = storeCarinfo('Honda', 'Civic', { color: 'Black' }, { features: ['Automatic', 'Navigation'] });
